      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="bg-brand-navy pt-4 pb-8 items-center">
          <View style={{ width: "100%", maxWidth: 480, paddingHorizontal: wide ? 32 : 24 }}>
            <View className="flex-row items-center justify-between mb-4">
              ...
              <Pressable className="bg-brand-gold px-3.5 py-1.5 rounded-full flex-row items-center gap-1 active:opacity-90">
        ...
        <View className="items-center py-6">
          <View style={{ width: "100%", maxWidth: 480, paddingHorizontal: wide ? 32 : 24 }}>
            ...
            <View className="flex-row items-center justify-between bg-brand-card p-4 border border-brand-hair rounded-2xl mb-4 shadow-xs">
              <View className="flex-row items-center gap-2">
                <Feather name="calendar" size={14} color="#5B6472" />
                <Text className="text-brand-navy text-xs font-bold">Class Schedule Grid</Text>
              </View>

              <Pressable className="flex-row items-center gap-1.5 bg-brand-gold px-3.5 py-1.5 rounded-full active:opacity-90">
                <Feather name="image" size={12} color="#14213D" />
                <Text className="text-brand-navy text-[11px] font-black uppercase tracking-wider">
                  Export as Image
                </Text>
              </Pressable>
            </View>
            ...
            <ScrollView
              ...
              className="rounded-2xl border border-brand-hair bg-white shadow-xs"
            >
                ...
                <View className="flex-row relative">
                  ...
                  {DAYS.map((day) => (
                    <View key={day} className="flex-1 min-w-[105px] border-r border-brand-hair relative">
                      ...
                      {SCHEDULE_ITEMS.filter((item) => item.days.includes(day)).map((item) => {
